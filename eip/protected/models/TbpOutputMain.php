...
/**
 * This is the model class for table "tbp_output_main".
 *
 * The followings are the available columns in table 'tbp_output_main':
 * @property string $id
 ...
 * @property string $ip
 */
class TbpOutputMain extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, cname, ename, feeno, account, memo, opt1, cemp, uemp, ctime, utime, ip', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TbpOutputMain the static model class
	 */
