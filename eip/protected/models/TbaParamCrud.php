...
/**
 * This is the model class for table "tba_param_crud".
 *
 * The followings are the available columns in table 'tba_param_crud':
 * @property string $id
 ...
 * @property string $ip
 */
class TbaParamCrud extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('param, cname, pvalue', 'required'),
	 ...
	 * @return TbaParamCrud the static model class
	 */
