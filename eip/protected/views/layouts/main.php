            ...
            $this->widget('application.components.YiiSmartMenu', array(
                ...
                'items'=>array(
                      ...
                      array('label'=>'基本資料管理', 
                               ...
                               'visible'=>!Yii::app()->user->isGuest,
                               'items' => array(
                                    array('label'=>'個人基本資料', 'url'=>array('/user/chgpwd')),
...
//                                    array('label'=>'管理員工資料', 'url'=>array('/user/admin')),
                                   array('label'=>'管理員工資料', 'url'=>array('/user/useradmin')),
                                    ...
                                    array('label'=>'職位管理', 'url'=>array('/tbsPosition/admin')),                                   
                        ...
                        array('label'=>'業績管理系統', 
                                ...
                                'items' => array(
                                    ...
                                    array('label'=>'業績支出查詢', 'url'=>array('tbpStore/storeperform')),
                                    ...
                                    array('label'=>'正航業績轉出', 'url'=>array('tbpPerformOut01/export')),
                                    ...
                                    array('label'=>'高階管理報表', 'url'=>array('tbpPerformRpt/rpt14')),
                                    array('label'=>'區域管理報表', 'url'=>array('tbpPerformRpt/rpt13')),
                                    array('label'=>'門市業績管理報表', 'url'=>array('tbpPerformRpt/rpt11')),
...
//                                    array('label'=>'業績報表(高階)', 'url'=>array('perform/report4')),
                        ...
                        array('label'=>'公佈欄系統', 
                                'url'=>array('/'),
                                'visible'=>!Yii::app()->user->isGuest && Yii::app()->user->checkAccess('Marketing'),
                                'items' => array(
...
//                                    array('label'=>'公佈欄管理', 'url'=>array('tbaBoardEmpLog/admin')),
                        ...
                        array('label'=>'差勤獎懲系統', 
                                'url'=>array('/'),
                                'visible'=>!Yii::app()->user->isGuest && Yii::app()->user->checkAccess('HumanResource'),
                                'items' => array(
                        ...
                        array('label'=>'會計作業系統', 
                                'url'=>array('/'),
                                'visible'=>!Yii::app()->user->isGuest && Yii::app()->user->checkAccess('Accountant'),
                                'items' => array(
                                    array('label'=>'門市業績支出', 'url'=>array('tbpStore/officeperform')),
                                    array('label'=>'門市零用金檢核', 'url'=>array('tbpOutputStore/outputcheck')),
                                    array('label'=>'門市支出主項', 'url'=>array('tbpOutputMain/admin')),
                                    array('label'=>'門市支出次項', 'url'=>array('tbpOutputSub/admin')),
                                    array('label'=>'門市支出細項', 'url'=>array('tbpOutputItem/admin')),
                                    array('label'=>'門市支出LOG', 'url'=>array('tbpOutputLog/admin')),
                                    array('label'=>'門市支出檢核', 'url'=>array('tbpOutputStore/inputcheck')),
                                ),                            
                            ),                                     
                        array('label'=>'薪資管理系統', 
                                'url'=>array('/'),
                                'visible'=>!Yii::app()->user->isGuest && Yii::app()->user->checkAccess('SalaryManager'),
                                'items' => array(
