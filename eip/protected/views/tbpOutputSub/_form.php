...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">		
                <?php echo $form->labelEx($model,'mainid'); ?>
                                    <?php echo $form->dropDownList($model,'mainid', CHtml::listData(
                                        TbpOutputMain::model()->findAll(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nextlog'); ?>
		<?php echo $form->radioButtonList($model,'nextlog', array( '1' => '是', '0' => '否' ), array('separator' =>' ')); ?>              
		<?php echo $form->error($model,'nextlog'); ?>           
	</div>
	...
	<div class="row">
		...
		<?php echo $form->error($model,'opt1'); ?>
                &nbsp<span class="required">預設為是</span>
	</div>
