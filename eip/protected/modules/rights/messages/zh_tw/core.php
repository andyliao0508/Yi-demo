...
return array (
  ...
  'Business rule' => '業務規則',
  'Business rule cannot be empty.' => '業務規則不能為空',
  ...
  'Delete' => '刪除',
  'Description' => '描述',
  'Do not change the name unless you know what you are doing.' => '不要修改這個名字，除非你知道你在做什麼。',
  'Generate' => '生成',
  'Generator' => '生成器',
  ...
  'No relations need to be set for the superuser role.' => '無需為超級用戶設置關係。',
  ...
  'Values within square brackets tell how many children each item has.' => '括號裡的數字表示這個項目有多少個子項。',
