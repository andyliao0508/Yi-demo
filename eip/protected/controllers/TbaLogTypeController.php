...
class TbaLogTypeController extends RController
{
	/**
   ...
   */       
	...
	{
		$model=new TbaLogType;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TbaLogType']))
		{
			$model->attributes=$_POST['TbaLogType'];
	...
	{
		$dataProvider=new CActiveDataProvider('TbaLogType');
	...
	{
		$model=new TbaLogType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TbaLogType']))
			$model->attributes=$_GET['TbaLogType'];
